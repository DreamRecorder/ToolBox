...
///     instead of a single byte array, the allocation
///     of which will fail for relatively small streams as it requires contiguous memory.
/// </summary>
public class MemoryTributaryStream : Stream /* http://msdn.microsoft.com/en-us/library/system.io.stream.aspx */
{
	...
	public MemoryTributaryStream ( ) => Position = 0;

	public MemoryTributaryStream ( byte [ ] source )
	{
	...
	public MemoryTributaryStream ( int length )
	{
		SetLength ( length );
		Position = length;
	...
	protected long blockSize = 1024 * 1024 * 64;
