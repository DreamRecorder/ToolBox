...
public class OwnerOption : EDnsOptionBase
{
	...
	public OwnerOption ( byte sequence , PhysicalAddress primaryMacAddress , PhysicalAddress wakeupMacAddress ) : this (
	 0 ,
	 sequence ,
	 primaryMacAddress ,
	 wakeupMacAddress )
	...
	public OwnerOption (
		...
		PhysicalAddress wakeupMacAddress ) : this ( version , sequence , primaryMacAddress , wakeupMacAddress , null )
	{
	}
	...
	public OwnerOption (
		...
		byte [ ]        password ) : this ( 0 , sequence , primaryMacAddress , wakeupMacAddress , password )
	{
	}
	...
	internal override void ParseData ( byte [ ] resultData , int startPosition , int length )
	{
		...
		{
			WakeupMacAddress =
				new PhysicalAddress ( DnsMessageBase.ParseByteData ( resultData , ref startPosition , 6 ) );
		}
