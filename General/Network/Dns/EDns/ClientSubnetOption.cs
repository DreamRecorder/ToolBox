...
public class ClientSubnetOption : EDnsOptionBase
{
	...
	public ClientSubnetOption ( byte sourceNetmask , IPAddress address ) : this ( sourceNetmask , 0 , address ) { }
	...
	/// <param name="address"> The address </param>
	public ClientSubnetOption ( byte sourceNetmask , byte scopeNetmask , IPAddress address ) : this ( )
	{
